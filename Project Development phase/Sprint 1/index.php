...
<body >
	<div class="container-scroller" style="background-color: #aaffff;">
					...
					<div class="row w-100 mx-0">
						<div class="col-lg-4 mx-auto">
							<div class="auth-form-light text-left py-5 px-4 px-sm-5">
								...
								<form class="pt-3" method="post" action="dashboard/process.php">
									...
									<div class="text-center mt-4 font-weight-light">
										Create a account?
										<a href="login.php" class="text-primary">Register</a>
									</div>
